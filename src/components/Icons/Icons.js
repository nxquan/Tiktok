...
export const SolidHomeIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const SolidUsersGroupIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const SolidLiveIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
